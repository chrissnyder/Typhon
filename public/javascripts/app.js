  ...
  (function() {
    ...
    TweetItem = (function(_super) {
      ...
      TweetItem.prototype.render = function(tweet) {
        ...
        return this.html(require('views/tweets/tweet_item')(this.tweet));
      };
    ...
    if (typeof module !== "undefined" && module !== null) module.exports = TweetItem;
...
window.require.define({"controllers/tweets": function(exports, require, module) {
  (function() {
    ...
    Tweets = (function(_super) {
      ...
      function Tweets() {
        this.addTweets = __bind(this.addTweets, this);
        this.addTweet = __bind(this.addTweet, this);      Tweets.__super__.constructor.apply(this, arguments);
        Tweet.bind('create', this.addTweet);
        Tweet.bind('refresh', this.allAll);
      }
      ...
      Tweets.prototype.addTweets = function() {
        return Tweet.each(this.addTweet);
      };
    ...
    $.ajaxSetup({
      beforeSend: function(xhr) {
        if (window.location.hostname === "0.0.0.0" || window.location.hostname === "localhost") {
          return Spine.Model.host = "http://localhost:3001";
        } else {
          return Spine.Model.host = "";
        }
      }
    });
  ...
  (function() {
    ...
    Tweet = (function(_super) {
      ...
      Tweet.fetch = function() {
        ...
        return $.getJSON('http://localhost:3001/twitter_status', function(data) {
    ...
    if (typeof module !== "undefined" && module !== null) module.exports = Tweet;
...
window.require.define({"views/repos": function(exports, require, module) {
  module.exports = function (__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
...
window.require.define({"views/tickets": function(exports, require, module) {
  module.exports = function (__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
